...
output "flow_event_queue_url" {
  value = aws_sqs_queue.flow_event.url
}

output "flow_event_queue_arn" {
  value = aws_sqs_queue.flow_event.arn
}
...
output "mailrelay_sync_queue_url" {
  value = aws_sqs_queue.mailrelay_sync.url
}

output "mailrelay_sync_queue_arn" {
  value = aws_sqs_queue.mailrelay_sync.arn
}
...
output "sequence_queue_url" {
  value = aws_sqs_queue.sequence_run.url
}
