  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 p-6">
      <div className="flex items-center gap-2 mb-2">
        ...
        <h2 className="text-sm font-semibold text-gray-900">{t("bots.callingTitle")}</h2>
      </div>
      <p className="text-sm text-gray-500 mb-4">{t("bots.callingDescription")}</p>
      ...
      {isLoading ? (
        ...
        <label className="flex items-center justify-between gap-4 cursor-pointer">
          <span className="text-sm text-gray-700">{t("bots.callingEnable")}</span>
          <button
            type="button"
            role="switch"
