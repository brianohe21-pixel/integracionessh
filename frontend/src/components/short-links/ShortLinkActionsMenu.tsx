...
type ShortLinkActionsMenuProps = {
  enabled: boolean;
  busy?: boolean;
  onCopy: () => void;
  onShowQr: () => void;
...
export function ShortLinkActionsMenu({
  enabled,
  busy = false,
  onCopy,
  onShowQr,
  ...
  const items: MenuItem[] = [
    ...
    {
      id: "open",
      label: t("shortLinks.openDestination"),
      icon: ExternalLink,
    ...
    {
      id: "toggle",
      label: enabled ? t("shortLinks.disable") : t("shortLinks.enable"),
  ...
  const menu =
    open && menuPosition && mounted ? (
      <div
        ref={rootRef}
        role="menu"
        aria-label={t("shortLinks.actionsMenu")}
        style={{
