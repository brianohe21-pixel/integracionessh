...
const VOICE_SCOPE_LABEL_KEYS: Record<string, string> = {
...
export function ApiKeyScopesModal({ apiKey, onClose }: ApiKeyScopesModalProps) {
  ...
  const [selected, setSelected] = useState<string[]>(getSelectedVoiceScopes(apiKey.scopes));
              ...
              >
                ...
                <div className="min-w-0">
                  <p className="text-sm font-medium text-primary">
                    {t(VOICE_SCOPE_LABEL_KEYS[scope] ?? scope)}
                  </p>
