...
import { getDocumentMetadata } from "@/lib/conversations/document-messages";
...
export function DocumentMessageBubble({ message, conversationId, botId }: Props) {
  const t = useT();
    ...
    <div className="space-y-2">
      ...
      >
        ...
        <span className="min-w-0 flex-1">
          ...
          <span className="mt-0.5 block text-xs text-secondary">PDF</span>
        </span>
