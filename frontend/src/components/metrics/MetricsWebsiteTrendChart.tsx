...
interface MetricsWebsiteTrendChartProps {
  website: WebsiteMetrics;
}

export function MetricsWebsiteTrendChart({ website }: MetricsWebsiteTrendChartProps) {
  const t = useT();
  ...
  const isEmpty = website.summary.pageviews === 0;
